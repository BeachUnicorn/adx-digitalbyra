...
urlpatterns = [
    ...
    # Ärendesystemet (apps/projects) - panelens skinn, se projects/base_board.html
    ...
    path("arenden/<int:pk>/panel/", project_views.issue_panel, name="issue_panel"),
    path("arenden/<int:pk>/falt/", project_views.issue_field, name="issue_field"),
    ...
    path(
        "arenden/<int:pk>/mejla-kunden/",
        project_views.issue_email_customer,
        name="issue_email_customer",
    ),
    path("arenden/<int:pk>/bilaga/", project_views.issue_attach, name="issue_attach"),
    path("arenden/<int:pk>/checklista/", project_views.checklist_add, name="checklist_add"),
    path("checklista/<int:pk>/", project_views.checklist_update, name="checklist_update"),
    path("arenden/<int:pk>/tid/", project_views.time_add, name="time_add"),
    path("tid/<int:pk>/", project_views.time_update, name="time_update"),
    ...
    path(
        "offerter/<int:pk>/kopiera-flera/",
        offer_views.offer_duplicate_many,
        name="offer_duplicate_many",
    ),
    path("offerter/<int:pk>/bilaga/", offer_views.offer_attach, name="offer_attach"),
    path(
        "offerter/bilaga/<int:pk>/ta-bort/",
        offer_views.offer_attachment_delete,
        name="offer_attachment_delete",
    ),
